          ...
          <div class="row">
            <div class="col-lg-8">
              <Scrollbars style={{ width: 750, height: 370 }}>
                <ul className="list-group m-4">{state.map(itemList)}</ul>
              </Scrollbars>
            </div>
            ...
            <div class="col-lg-4">
              <div class="card position-sticky top-0">
                <div class="p-3 bg-light bg-opacity-10">
                  ...
                  <div class="d-flex justify-content-between mb-1 small">
                    <span>Coupon (Code: CRYPTO80)</span>{" "}
                    <span class="text-danger">-0.0001</span>
                  </div>
                  <hr />
                  <div class="d-flex justify-content-between mb-3 small">
                    <span>TOTAL</span>{" "}
                    <strong class="text-dark">Gwe {total}</strong>
                  </div>
                  ...
                  <div class="form-check mb-1 small">
                    <label class="form-check-label">
                      ...
                      <a href="#">0x25aAe20c1037d4FcCc41b81F03e7b9b540F79831</a>
                    </label>
                  </div>
                  {(!MetaAccount && (
                    <>
