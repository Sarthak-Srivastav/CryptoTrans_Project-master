      ...
      <div className="mb-10">
        <div className="  flex flex-col justify-center items-center bg-gray-100 mb-5 ">
          <img
            ...
            className=" w-32 h-20 my-2"
          ></img>
          <p className=" font-bold text-3xl mb-2">Contact Us</p>
          <p className=" font-semibold text-lg text-gray-600 ">
            Have A Query? Then don't worry!{" "}
            <p className="text-center">We've Got you!</p>{" "}
          </p>
        </div>
        <div className="flex justify-center items-center">
          ...
          <form
            validated={true}
            onSubmit={submit}
            className=" cbox rounded flex-col px-12 py-4 space-y-3 justify-center items-center flex  my-10 bg-gray-50"
          >
            ...
            <CFormFloating>
              ...
              <Form.Text className="text-muted">
                {HasemailError === true ? (
                  <p className="text-red-700">Enter a valid email</p>
                ) : (
                  ""
                )}
              </Form.Text>
              ...
              <Form.Text className="text-muted">
                {HassubError === true ? (
                  <p className="text-red-700">
                    Enter a Subject greater than or equal 3
                  </p>
                ) : (
                  " "
                )}
            ...
            <CFormFloating>
              ...
              <Form.Text className="text-muted">
                {HasmesError === true ? (
                  <p className="text-red-700">
                    Enter a query greater than or equal 20 char
                  </p>
                ) : (
                  " "
                )}
            ...
            <div className="">
              <button className="  mt-3 bg-red-700 px-3 py-1 hover:bg-red-500 text-white rounded ">
                Send message
              </button>
            </div>
          </form>
